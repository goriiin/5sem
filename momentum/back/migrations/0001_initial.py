    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes_count', models.IntegerField(default=0)),
                ('question', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='back.post')),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='back.profile')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='back.post')),
